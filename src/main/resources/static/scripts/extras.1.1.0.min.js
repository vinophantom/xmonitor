...
!function (e) {
    jQuery(document).ready(function () {
        ...
        }, o = "_sd_demo_page_promo", s = t.getItem(o), a = e(".promo-popup");
        s ? setTimeout(function () {
            ...
            e.preventDefault(), "undefined" !== dataLayer && dataLayer.push({
                ...
                data: {category: "product-demo", action: "cta-upsell", label: "shards-dashboard-pro"}
            }), window.location = e.target.href
        });
        var n, i = e(".color-switcher .accent-colors"), r = e("#main-stylesheet"), c = r.attr("href"),
            d = r.attr("data-version");
        i.on("click", "li", function () {
            var t = e(this).attr("data-color"), o = "styles/accents/" + t + "." + d + ".css";
            "primary" == t && (o = c), i.find("li.active").removeClass("active"), e(this).addClass("active"), r.attr("href", o), function (t) {
                ...
                o.attr("src", "images/xmonitor.svg")
        ...
        //         twitter: {count: "horizontal", via: "DesignRevision", hashtags: "bootstrap,uikit"}
        //     },
        //     enableTracking: !0,
        //     enableHover: !1,
        //     enableCounter: !1
